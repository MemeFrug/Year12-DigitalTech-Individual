...
const pickableItems = {
    items: [
        ...
        { name: "Cheese Balls", category: val.categories.Food, cost: 6 },
        { name: "Coke", category: val.categories.Drinks, cost: 4 },
        { name: "Cup With Logo", category: val.categories.Other, cost: 8 },
        { name: "Pepsi", category: val.categories.Drinks, cost: 4 },
        { name: "Fanta", category: val.categories.Drinks, cost: 4 },
        { name: "Creaming Soda", category: val.categories.Drinks, cost: 4 },
        { name: "Pineapple Pizza", category: val.categories.Food, cost: 16 },
        { name: "Prawn Pizza", category: val.categories.Food, cost: 23 },
        { name: "BBQ Pizza", category: val.categories.Food, cost: 16 },
        { name: "Fried Rice", category: val.categories.Food, cost: 17 },
        { name: "Stirfry", category: val.categories.Food, cost: 23 },
        { name: "Hot Fudge Sundae", category: val.categories.Other, cost: 6 },
        { name: "Chicken Tenders", category: val.categories.Food, cost: 12 },
        { name: "Hash Browns", category: val.categories.Food, cost: 10 },
        { name: "Chicken Soup", category: val.categories.Food, cost: 16 },
        { name: "Brownies", category: val.categories.Other, cost: 9 },
        { name: "Butter Chicken", category: val.categories.Food, cost: 21 },
        { name: "Soft Serve", category: val.categories.Other, cost: 6 },
        { name: "Chocolate Milkshake", category: val.categories.Drinks, cost: 8 },
        { name: "Strawberry Milkshake", category: val.categories.Drinks, cost: 8 },
        { name: "Biscoff Milkshake", category: val.categories.Drinks, cost: 8 },
    ],
